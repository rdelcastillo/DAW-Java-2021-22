 ...
 * una transferencia entre una cuenta y otra. 
 * 
 * En caso de saldo negativo se lanza una excepción.
 * 
...
public class CurrentAccount {
  ...
  public void withdraw(double money) throws NegativeBalanceException {
    throwExceptionIfMoneyIsNegative(money);
    throwExceptionIfBalanceIsNegative(money);
    balance -= money;
  }
  
  public void transfer(CurrentAccount other, double money) throws NegativeBalanceException {
    throwExceptionIfMoneyIsNegative(money);
    throwExceptionIfBalanceIsNegative(money);
    this.balance -= money;
    other.balance += money;
  ...
  private void throwExceptionIfBalanceIsNegative(double money) throws NegativeBalanceException {
    if (balance-money < 0) {
      throw new NegativeBalanceException("Saldo insuficiente en la cuenta " + number 
          + " para la salida de " + money + "€");
    }
